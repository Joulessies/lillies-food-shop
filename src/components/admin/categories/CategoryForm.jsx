...
const CategoryForm = () => {
  ...
  // Get predefined name from location state if it exists
  const predefinedName = location.state?.predefinedName || "";

  const [category, setCategory] = useState({
    name: predefinedName, // Use predefined name if available
    description: "",
    active: true,
  });
          ...
          <Form noValidate validated={validated} onSubmit={handleSubmit}>
            ...
            <Form.Group className="mb-3">
              <Form.Check
                ...
                onChange={(e) =>
                  setCategory((prev) => ({ ...prev, active: e.target.checked }))
                }
              />
            </Form.Group>
            ...
            >
              ...
              <FaSave className="me-2" /> {isEditing ? "Update" : "Create"}{" "}
              Category
            </Button>
          </Form>
        </Card.Body>
