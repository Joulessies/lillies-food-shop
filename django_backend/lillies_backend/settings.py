...
if DEBUG:
    ...
    LOG_DIR = os.getenv('DJANGO_LOG_DIR', '/var/log/app-logs')
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'db', 'db.sqlite3') if os.getenv('AWS_LAMBDA_FUNCTION_NAME') else BASE_DIR / 'db.sqlite3',
    }
}
...
# Ensure database directory exists in Lambda environment
